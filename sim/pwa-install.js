/* Rush Hour · จำลองขยายสาขา — ปุ่ม "ติดตั้งแอป"
...
(function () {
  ...
  css.textContent =
    ...
    "background:var(--accent-grad,linear-gradient(135deg,#E3BE4A 0%,#C2941A 100%));" +
  ...
  function showSheet() {
    ...
    ov.innerHTML =
      '<div class="pwa-sheet"><h3>ติดตั้ง "จำลองสาขา" ลงมือถือ</h3>' + steps +
