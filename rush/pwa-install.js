/* ============================================================================
   ...
   ============================================================================ */
(function () {
  var KEY = "rushCoffeeInstallDismissed";
  var deferred = null;
  ...
  function showBanner() {
    ...
    bar.innerHTML =
      '<div style="width:38px;height:38px;border-radius:11px;flex-shrink:0;display:grid;place-items:center;color:#fff;background:var(--ink,#1A1814)">' +
      ...
      '</div>' +
      '<button id="rushInstallGo" style="flex-shrink:0;border:none;cursor:pointer;font-family:inherit;font-weight:800;font-size:13px;padding:10px 14px;border-radius:11px;color:var(--on-accent,#fff);background:var(--accent,#E5C46A)">ติดตั้ง</button>' +
  ...
  function showHelp() {
    ...
    wrap.innerHTML =
      '<div style="background:var(--surface,#fff);border-radius:20px;padding:22px 20px;width:100%;max-width:360px;box-shadow:0 10px 34px rgba(0,0,0,.24);font-family:inherit">' +
        ...
        warn +
        '<button id="rushHelpClose" style="width:100%;margin-top:16px;border:none;cursor:pointer;font-family:inherit;font-weight:800;font-size:14.5px;padding:13px;border-radius:12px;color:var(--on-accent,#fff);background:var(--accent,#E5C46A)">เข้าใจแล้ว</button>' +
      '</div>';
